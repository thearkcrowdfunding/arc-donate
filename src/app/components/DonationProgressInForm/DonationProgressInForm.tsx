...
export default function DonationProgressInForm() {
    ...
    return (
        <div className='donation-progress-container-in-form'>
            <div className='donation-progress-text'>
                <b>До конца ноября нужно собрать всего ${currentTarget} </b><br className='mobile-only' /> это  всего {currentTarget / 20} человек по 20$
            </div>
